...
$.fn.gridEditor = function( options ) {
    ...
    self.each(function(baseIndex, baseElem) {
        ...
        var canvas,
            ...
            htmlTextArea
        ;
        var colClasses = ['qc-col-md-', 'qc-col-sm-', 'qc-col-xs-'];
        ...
        function setup() {
            ...
            $.each(settings.new_row_layouts, function(j, layout) {
                var btn = $('<a style ="color:#2CC185;width: 19.53%; margin-right:5px;padding:5px;font-size:15px;background-color:#fff;border: 1px solid #3c763d ;" class="btn btn-xs" />')
