...
class WC_Widget_jarvis extends WP_Widget
{
    ...
    function update($new_instance, $old_instance)
    {
        ...
        $instance['jarvis_title'] = strip_tags(stripslashes($new_instance['jarvis_title']));
    ...
    function form($instance)
    {
        ...
        <div class="jarvis-widget">
            ...
            <p>
                <label><?php _e("Search Phrase:", "jarvis"); ?></label>
            <div class="widget-no-phrase">
                <?php _e("Set search sentence from WooCommerce -> JARVIS-Woo", "jarvis"); ?>
            </div>

            </p>

            <p>
                <label for="<?php echo $this->get_field_id('jarvis_title'); ?>"><?php _e('Title:', 'jarvis') ?></label>
                ...
                <small><?php _e("This is optional and appears above the widget.", "jarvis"); ?></small>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('jarvis_font_size'); ?>"><?php _e('Font Size:', 'jarvis') ?></label>
                ...
                px
                <small><?php _e("search phrase font size.", "jarvis"); ?></small>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('jarvis_secondary_font_size'); ?>"><?php _e('Font Size:', 'jarvis') ?></label>
                <input type="text" class="small-number"
                ...
                px
                <small><?php _e("Widget content font size.", "jarvis"); ?></small>
            </p>
